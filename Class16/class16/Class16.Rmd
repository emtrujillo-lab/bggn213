...
##print everythig but the first column
...
##remove those rows with `zero` but you don't need these. use `rowSums()`
...
#now go to the reactome website

x <- 1:10 Predict without using R the result of: x[ c(TRUE, FALSE) ]
```{r}
x <- 1:10
x[ c(TRUE, FALSE) ]
```
