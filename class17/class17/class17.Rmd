...
```{r}
sum(virus$Country.Region == "Mainland China" & virus$type == "death")
...
```{r}
sum(virus$Country.Region == "Italy" & virus$type == "death")

Italy_deaths <- sum(virus$Country.Region == "Italy" & virus$type == "death")
```

sum(virus[virus$type == "death", "cases"])
...
```{r}
sum(virus$Country.Region == "Iran" & virus$type == "death")
...
```{r}
sum(virus$Country.Region == "US" & virus$type == "death")
